...
//
// One deliberate exception: `drinkWindowEstimated`. The tool asks for it,
// but it qualifies the drink-window rows rather than being a change of its
// own, so it is applied by windowEstimatedFromProposal in app/actions.js
// instead of appearing here as its own diff row. It is the only tool field
// not in this list - anything else missing is a bug, not a carve-out.
