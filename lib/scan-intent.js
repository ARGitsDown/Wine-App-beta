...
export const SCAN_INTENTS = [
  ...
  {
    value: "flight",
    // Same status as Cellar - a flight only ever queues bottles you
    // actually have (see FlightPick in prisma/schema.prisma: "you cannot
    // open a wine you do not have"). What's different is what happens once
    // the batch is saved: ScanPanel offers to bundle everything from a
    // "flight" photo into a chosen or brand-new flight, and land there
    // instead of on the cellar.
    status: "inventory",
    short: "Flight",
    label: "Adding to a tasting flight",
    hint: "Bottles for tonight — saved to the cellar and queued together",
  },
];
